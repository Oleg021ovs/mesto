 class Card {
  ...
  _setEventListeners(){
    this._element.querySelector('.elements__images').addEventListener('click', () => this._handleCardClick());
    this._element.querySelector('.elements__like-btn').addEventListener('click', () => this._likeCard());
    this._element.querySelector('.element__btn-delete').addEventListener('click', () => this._deleteCard());
  }
