...
const popupItemHeading = popupFormProfile.querySelector('.popup_item_heading');
const popupItemSubHeading = popupFormProfile.querySelector('.popup_item_subheading');
